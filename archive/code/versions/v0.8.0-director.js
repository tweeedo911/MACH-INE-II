...
import { dna, PRIM_TYPES, generateDNA } from './dna.js';
import { entities, resetGenerations } from './generations.js';
import { startInvertDissolve, setChromaticShift, invertTarget, resetClimax } from './colors.js';
...
export function setFraming(type, W, H) {
  ...
  if (type === 'WIDE') { framing.targetZoom = 1; framing.targetX = 0; framing.targetY = 0; framing.panDirX = 0; }
    ...
    framing.targetY = 0;
    framing.panDirX = CFG.camPanSpeed;
    framing.panTime = 0;
  }
}
...
function pickAutoShot(state, W, H) {
  ...
  else if (state.trajectory === 0) setFraming('PAN', W, H);
